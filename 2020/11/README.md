...
- Otherwise, the seat's state does not change. Floor (```.```) never changes; seats don't move, and nobody sits on the 
floor.
...
count 26 occupied seats. Given the new visibility method and the rule change for occupied seats becoming empty, 
